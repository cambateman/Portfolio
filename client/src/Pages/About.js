        ...
        <div className="about-wrapper">
            ...
            <div className="about-flex-container">
                ...
                <div className="about-p-container">
                    ...
                    <p className="about-p">
                        I'm a Fullstack Web Developer from Vancouver BC. I took a 
                        ...
                        I decided to invest in my technical skillset by learning how to code.
                    </p>
                    <p className="about-p">
                        I am a graduate of the Software Systems Developer program at BCIT. The Software Systems Developer program features an accelerated, 
                    ...
                    <p className="about-p">
                        ...
                        Outside of coding, I love sports and reading. I enjoy staying in shape and have a sport for every almost every season. Golfing in the summer, 
